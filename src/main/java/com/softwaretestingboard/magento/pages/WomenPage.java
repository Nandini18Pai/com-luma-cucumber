...
public class WomenPage extends Utility {
    ...
    List<WebElement> OriginalDisplay;
    ...
    public void mouseHooverOnWomenMenu() {
        mouseHoverToElement(womenMenu);
    }

    public void mouseHooverOnWomenTop() {
        mouseHoverToElement(womenTop);
    }
    ...
    public void selectSortByFilterProductName(String sortBy) {
        selectByVisibleTextFromDropDown(sortByProductName, sortBy);
    }
...
// * Verify the products name display in alphabetical order
    ...
    public void selectSortByFilterProductPrice(String sortBy) {
        selectByVisibleTextFromDropDown(sortByProductName, sortBy);
    }
